...
import { Comments, offersMocks } from '../../types/offers';

function Property(): JSX.Element {
  const numberCurrentFilmId = useParams<{ id?: string }>().id;
  const history = useHistory();
  const [offer, setOffer] = useState<offersMocks>();
  const [comments, setComments] = useState<Comments>();
  //const [comments, setComments] = useState<offersMocks>();

  useEffect(() => {
    api.get(`${BACKEND_URL}/hotels/${numberCurrentFilmId}`)
  ...
  useEffect(() => {
    api.get(`${BACKEND_URL}/comments/${numberCurrentFilmId}`)
                      ...
                      <div className="reviews__info">
                        <div className="reviews__rating rating">
                          <div className="reviews__stars rating__stars">
                            <span style={{ width: `${comment.rating}` }}></span>
                            <span className="visually-hidden">Rating</span>
                          </div>
                        </div>
